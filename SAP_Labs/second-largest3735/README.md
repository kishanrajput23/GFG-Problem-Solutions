...
**Topics:** SAP Labs, Rockstand, Arrays, Searching, Find Second Largest Element Array  

**Problem Description:**

<p><span style="font-size: 18px;">Given an array of positive integers <strong>arr[]</strong>, return the<strong> </strong>second largest element from the array. </span><span style="font-size: 18px;">If the second largest element doesn't exist then return <strong>-1.</strong></span></p>
